...
export const translations = {
  fr: {
    ...
    admin: {
      ...
      commissions: "Rapport",
      pettyCashNav: "Petite caisse",
      pettyCashTitle: "Petite caisse par magasin",
      pettyCashSubtitle:
        "Solde indicatif : caisse au départ moins la somme des rachats (prix × quantité, sans commissions). Les demandes annulées sont exclues. La provenance magasin sur chaque ligne doit correspondre au nom du magasin dans le référentiel.",
      pettyCashOpeningLabel: "Caisse au départ",
      pettyCashBuybackOutLabel: "Sorties rachat",
      pettyCashBalanceLabel: "Solde estimé",
      pettyCashStoreColumn: "Magasin",
      pettyCashOrphansTitle: "Rachats rattachés à un magasin inconnu",
      ...
      globalYearToReceiveTitle: "À recevoir (année en cours)",
      ownerCommissionToReceiveLabel: "Commission proprio à recevoir",
      otherCommissionToReceiveLabel: "Autre commission à recevoir",
      totalToReceiveLabel: "Total à recevoir",
      totalToReceiveBuybackHint:
        "Le total inclut le montant des rachats (à titre indicatif).",
      ...
      assignStore: "Associer un magasin",
      errorUpdateStore: "Erreur lors de l’association du magasin",
      filterStoresSelection: "Sélection magasin",
      storesSelectedCount: "magasin(s) sélectionné(s)",
      ...
      colManager: "Gérant",
      colOwner: "Proprio",
      filterByOrderStatus: "Statut",
      ordersSortBy: "Trier",
      sortDateDesc: "Date (récent)",
      sortDateAsc: "Date (ancien)",
      sortStoreAsc: "Magasin (A–Z)",
      sortStoreDesc: "Magasin (Z–A)",
      ordersFilteredCount: "commandes affichées",
      ...
      orderMarkCancelled: "Annulé",
      orderMarkCancelledConfirm:
        "Marquer cette commande comme annulée ? Les lignes passeront au statut « Annulé ».",
      deleteConfirm:
      ...
      reportChartTopModels: "Appareils les plus rachetés (unités)",
      reportChartCommissionByType: "Commissions par type",
      reportAxisBuyback: "Rachats ($)",
      reportAxisUnits: "Unités",
      ...
      reportStatsOnlyHint:
        "Marquez une commande « Payé » dans l’onglet « Demandes de rachat » pour la retirer du bloc « À recevoir » (commissions et total indicatif).",
  ...
  en: {
    ...
    admin: {
      ...
      commissions: "Report",
      pettyCashNav: "Petty cash",
      pettyCashTitle: "Petty cash by store",
      pettyCashSubtitle:
        "Indicative balance: opening cash minus buybacks (price × quantity, excluding commissions). Cancelled requests are excluded. The store on each line must match the store name in reference data.",
      pettyCashOpeningLabel: "Opening cash",
      pettyCashBuybackOutLabel: "Buyback outflows",
      pettyCashBalanceLabel: "Estimated balance",
      pettyCashStoreColumn: "Store",
      pettyCashOrphansTitle: "Buybacks linked to an unknown store",
      pettyCashOrphansHint:
      ...
      globalYearToReceiveTitle: "Outstanding (current year)",
      ownerCommissionToReceiveLabel: "Owner commission to receive",
      otherCommissionToReceiveLabel: "Other commission to receive",
      totalToReceiveLabel: "Total to receive",
      totalToReceiveBuybackHint:
        "Total includes buyback amounts (indicative).",
      ...
      errorUpdateStore: "Error assigning store",
      filterStoresSelection: "Store selection",
      storesSelectedCount: "store(s) selected",
      ...
      sortStoreAsc: "Store (A–Z)",
      sortStoreDesc: "Store (Z–A)",
      ordersFilteredCount: "orders shown",
      resetFilters: "Reset",
      ...
      reportChartTopModels: "Most trade-in devices (units)",
      reportChartCommissionByType: "Commissions by type",
      reportAxisBuyback: "Buyback ($)",
      reportAxisUnits: "Units",
      ...
      reportStatsOnlyHint:
        "Mark an order as “Paid” in the “Trade-in requests” tab to remove it from the “Outstanding” summary (commissions and indicative total).",
      reportStatsSectionTitle: "STATS",
